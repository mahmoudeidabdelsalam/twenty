...
if (!class_exists('\\BootstrapBasic4\\BootstrapBasic4')) {
    ...
    class BootstrapBasic4
    {
        ...
        public function enqueueScriptsAndStyles()
        {
            ...
            wp_enqueue_style('bootstrap-basic4-main', get_template_directory_uri() . '/assets/css/main.css', array(), '1.2.9');
            wp_enqueue_style('animate-min', get_template_directory_uri() . '/assets/css/animate.min.css', array());
            wp_enqueue_style('font-awesome', get_template_directory_uri() . '/assets/css/font-awesome.css', array());
            
            wp_enqueue_style('font-awesome-min', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array());
            wp_enqueue_style('gallery-1', get_template_directory_uri() . '/assets/css/gallery-1.css', array());
            wp_enqueue_style('magnific-popup', get_template_directory_uri() . '/assets/css/magnific-popup.css', array());
            wp_enqueue_style('owl-carousel-css', get_template_directory_uri() . '/assets/css/owl.carousel.css', array());
            wp_enqueue_style('owl-transitions', get_template_directory_uri() . '/assets/css/owl.transitions.css', array());
            wp_enqueue_style('prettyPhoto', get_template_directory_uri() . '/assets/css/prettyPhoto.css', array());


            wp_enqueue_script('jquery', get_template_directory_uri() . '/assets/js/jquery.js', true);
            wp_enqueue_style('bootstrap-basic4-wp-main', get_stylesheet_uri(), array(), '1.2.9');
            ...
            wp_enqueue_script('owl-carousel', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array('jquery'), '2.6.4', true);
            wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', true);
            wp_enqueue_script('mousescroll', get_template_directory_uri() . '/assets/js/mousescroll.js', true);
            wp_enqueue_script('smoothscroll', get_template_directory_uri() . '/assets/js/smoothscroll.js', true);
            wp_enqueue_script('jquery-prettyPhoto', get_template_directory_uri() . '/assets/js/jquery.prettyPhoto.js', true);
