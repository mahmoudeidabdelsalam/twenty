<div class="wrap">
    ...
    echo sprintf(__('This theme can use all Bootstrap 4 classes, elements and styles. Please read the %1$sBootstrap 4 document2$s.', 'bootstrap-basic4'), '<a href="https://getbootstrap.com/docs/4.2/getting-started/introduction/" target="bootstrap4_doc">', '</a>'); 
    ?></p>
    ...
    <p><?php 
    /* translators: %1$s: Open link, 2$s: Close link */
    echo sprintf(__('This theme comes with Font Awesome 5, please read the %1$sFont Awesome documentation2$s for icon classes and features.', 'bootstrap-basic4'), '<a href="https://fontawesome.com/" target="fontawesome5_doc">', '</a>'); 
    ?></p>
    ...
    <p>
        <?php 
        /* translators: %1$s: Open link, 2$s: Close link */
        echo sprintf(__('You can see what was changed in each version or each commits on our %1$sGitHub page2$s.', 'bootstrap-basic4'), '<a href="https://github.com/Rundiz-WP/bootstrap-basic4" target="bb4_commits">', '</a>'); 
        ?> 
